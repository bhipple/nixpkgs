{ lib, buildPythonApplication, fetchPypi, plaid-python, wheel, twine, docopt, python-dateutil }:
...
buildPythonApplication rec {
  ...
  propagatedBuildInputs = [ plaid-python wheel twine docopt python-dateutil ];
